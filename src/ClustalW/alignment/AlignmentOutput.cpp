 ...
 */
bool AlignmentOutput::openExplicitFile(unique_ptr<ofstream>& outFile, string fileName)
{
    if (fileName == "")
    {
 ...
 */
string AlignmentOutput::openOutputFile(unique_ptr<ofstream>& outFile, string prompt,
