...
class TreeInterface
{
    public:
         ...
         */
        shared_ptr<AlignmentSteps> getWeightsAndStepsFromDistMat(vector<int>* seqWeights,
                                                          DistMatrix* distMat,
                                                          Alignment *alignPtr,
                                                          int seq1, int nSeqs,
         ...
         */
        shared_ptr<AlignmentSteps> getWeightsAndStepsFromTree(Alignment* alignPtr,
    ...
    private:
        shared_ptr<AlignmentSteps> getWeightsAndStepsFromDistMatNJ(vector<int>* seqWeights,
                                                          DistMatrix* distMat,
                                                          Alignment *alignPtr,
                                                          int seq1, int nSeqs,
                                                          string* phylipName, bool* success);

        shared_ptr<AlignmentSteps> getWeightsAndStepsUseOldGuideTreeNJ(DistMatrix* distMat,
        ...
        shared_ptr<AlignmentSteps> getWeightsAndStepsFromTreeNJ(Alignment* alignPtr,
                               DistMatrix* distMat, string* treeName,
                               vector<int>* seqWeights, int fSeq, int numSeqs, bool* success);

        /** UPGMA functions */
        shared_ptr<AlignmentSteps> getWeightsAndStepsFromDistMatUPGMA(vector<int>* seqWeights,
                                 DistMatrix* distMat, Alignment *alignPtr,
                                 int seq1, int nSeqs, string* phylipName, bool* success);

        shared_ptr<AlignmentSteps> generateTreeFromDistMatUPGMA(RootedGuideTree* guideTree,
